...
smallStepB (Or FALSE b,s) = (FALSE,s)
...
teste2 :: B
teste2 = (Leq (Soma (Var "x") (Num 3))  (Mult (Num 20) (Num 3)))


---
-- Exemplos de Programas Imperativos:
testec0 :: C
testec0 = (Atrib (Var "x") (Num 20))

testeif :: C
testeif = (If TRUE (Atrib (Var "x") (Num 10)) (Atrib (Var "x") (Num 200)))
